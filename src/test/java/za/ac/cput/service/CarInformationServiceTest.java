...
class CarInformationServiceTest {
    ...
    void setUp() {
        ...
        carInformation1 = CarInformationFactory.buildCarInformation(
                ...
                "Red 5 door car with 50 000km mileage", "Leather seats, Navigation system, Bluetooth", user1,
                2000, "Available",
        ...
        carInformation3 =CarInformationFactory.buildCarInformation(
                "Ford", "Focus", "2018", "Manual", "Plate-789", "Blue 5 door car with 30 000km mileage", "Cloth seats, Navigation system, Bluetooth", user2, 1800, "Available",
        ...
        carInformation4 = CarInformationFactory.buildCarInformation(
                "BMW", "3 Series", "2021", "Automatic", "Plate-321", "White 4 door car with 10 000km mileage", "Leather seats, Sunroof, Bluetooth", user2, 3500, "Available",
        ...
        carInformation5 = CarInformationFactory.buildCarInformation(
                "Audi", "A4", "2022", "Manual", "Plate-654", "White 4 door car with 5 000km mileage", "Leather seats, Navigation system, Bluetooth", user3, 3700,"Available",
        ...
        carInformation6 = CarInformationFactory.buildCarInformation(
                "Mercedes", "C180", "2020", "Automatic", "Plate-987", "Silver 4 door car with 20 000km mileage", "Leather seats, Sunroof, Bluetooth", user3, 4000, "Available",
        ...
        carInformation7 = CarInformationFactory.buildCarInformation(
                "Volkswagen", "Golf", "2019", "Manual", "Plate-147", "White 5 door car with 25 000km mileage", "Cloth seats, Navigation system, Bluetooth", user4, 2000,"Available",
        ...
        carInformation8 = CarInformationFactory.buildCarInformation(
                "Hyundai", "Elantra", "2018", "Automatic", "Plate-258", "White 4 door car with 35 000km mileage", "Cloth seats, Bluetooth", user4, 1600, "Available",
        ...
        carInformation9 =CarInformationFactory.buildCarInformation(
                "Nissan", "X-trail", "2017", "Manual", "Plate-369", "Dark gray 4 door car with 45 000km mileage", "Leather seats, Navigation system, Bluetooth", user3, 1400, "Available",
                loadPicture("al1.jpg"), loadPicture("al2.jpg"), loadPicture("al3.jpg")
        );

        carInformation10 = CarInformationFactory.buildCarInformation(
                "Mazda", "3", "2016", "Automatic", "Plate-9877", "Red 5 door car with 55 000km mileage", "Cloth seats, Bluetooth", user1, 1200, "Available",
